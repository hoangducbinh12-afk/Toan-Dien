...
st.set_page_config(page_title="9 BIEN SIEU CAP", layout="centered")
...
BO_MAP = {
    "bo 00": [0, 5, 50, 55],
    "bo 01": [1, 10, 6, 60, 51, 15, 56, 65],
    "bo 02": [2, 20, 7, 70, 52, 25, 57, 75],
    "bo 03": [3, 30, 8, 80, 53, 35, 58, 85],
    "bo 04": [4, 40, 9, 90, 54, 45, 59, 95],
    "bo 11": [11, 16, 61, 66],
    "bo 12": [12, 21, 17, 71, 62, 26, 67, 76],
    "bo 13": [13, 31, 18, 81, 63, 36, 68, 86],
    "bo 14": [14, 41, 19, 91, 64, 46, 69, 96],
    "bo 22": [22, 27, 72, 77],
    "bo 23": [23, 32, 28, 82, 73, 37, 78, 87],
    "bo 24": [24, 42, 29, 92, 74, 47, 79, 97],
    "bo 33": [33, 38, 83, 88],
    "bo 34": [34, 43, 39, 93, 84, 48, 89, 98],
    "bo 44": [44, 49, 94, 99]
}
...
GIAP_MAP = {
    "Ty": [0, 12, 24, 36, 48, 60, 72, 84, 96],
    "Suu": [1, 13, 25, 37, 49, 61, 73, 85, 97],
    "Dan": [2, 14, 26, 38, 50, 62, 74, 86, 98],
    "Mao": [3, 15, 27, 39, 51, 63, 75, 87, 99],
    "Thin": [4, 16, 28, 40, 52, 64, 76, 88],
    "Ty.": [5, 17, 29, 41, 53, 65, 77, 89],
    "Ngo": [6, 18, 30, 42, 54, 66, 78, 90],
    "Mui": [7, 19, 31, 43, 55, 67, 79, 91],
    "Than": [8, 20, 32, 44, 56, 68, 80, 92],
    "Dau": [9, 21, 33, 45, 57, 69, 81, 93],
...
with st.sidebar:
    ...
    if st.session_state.db:
        sel = st.selectbox("Ban sao luu:", list(st.session_state.db.keys())[::-1])
